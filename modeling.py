    ...
    with tf.variable_scope(scope, default_name="bert", reuse=reuse):
      ...
      with tf.variable_scope("encoder", reuse=reuse):
        ...
        attention_mask = create_attention_mask_from_input_mask(
          input_ids, input_mask, batch_size, seq_length, dtype=tf.float32)
        ...
        self.all_encoder_layers = transformer_model(
            ...
            initializer_range=config.initializer_range,
            do_return_all_layers=True, reuse=reuse)
...
def create_attention_mask_from_input_mask(from_tensor, to_mask, batch_size, seq_length, dtype=tf.float32):
...
def transformer_model(input_tensor,
                      ...
                      attention_probs_dropout_prob=0.1,
                      initializer_range=0.02,
                      do_return_all_layers=False, reuse=False):
  ...
  for layer_idx in range(num_hidden_layers):
    with tf.variable_scope("layer_%d" % layer_idx, reuse=reuse):
